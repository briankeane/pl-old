module PL
  class MoveSpin < UseCase
    def run(attrs)
      ...
      spin1 = PL::Database.db.get_spin({ current_position: attrs[:old_position],
      ...
      new_position = PL::Database.db.get_spin({ current_position: attrs[:new_position],
                                                  station_id: station.id })
      ...
      PL::Database.db.move_spin({ station_id: station.id,
