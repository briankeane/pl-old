module PL
  class SeedDB
    def self.run
      @@songs = []
      @@songs << PL.db.create_song({ title: "Bar Lights", artist: "Brian Keane", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      @@songs << PL.db.create_song({ title: "Eating For Two", artist: "Brian Keane", duration: 226000, sing_start: 5000, sing_end: 208000,audio_id: 2 })
      @@songs << PL.db.create_song({ title: "You Can't Go Home", artist: "Brian Keane", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      ...
      @@songs << PL.db.create_song({ title: "Finally Free", artist: "Brian Keane", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      @@songs << PL.db.create_song({ title: "Coming Home", artist: "Brian Keane", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      @@songs << PL.db.create_song({ title: "Old With You", artist: "Brian Keane", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      @@songs << PL.db.create_song({ title: "Do Something Wrong", artist: "Brian Keane", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      ...
      @@songs <<  PL.db.create_song({ title: "Could It Be", artist: "Charlie Worsham", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      ...
      @@songs <<  PL.db.create_song({ title: "Hard to Love", artist: "Will Hoge", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      ...
      @@songs <<  PL.db.create_song({ title: "Even If it Breaks Your Heart", artist: "Will Hoge", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      @@songs <<  PL.db.create_song({ title: "What Could I Do", artist: "Will Hoge", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      ...
      @@songs <<  PL.db.create_song({ title: "Just Like Me", artist: "Will Hoge", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      @@songs <<  PL.db.create_song({ title: "Highway Wings", artist: "Will Hoge", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      ...
      @@songs <<  PL.db.create_song({ title: "My Winter Coat", artist: "Will Hoge", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      @@songs <<  PL.db.create_song({ title: "Trains I Missed", artist: "Brian Keane", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
      ...
      @@songs <<  PL.db.create_song({ title: "Songs About Trucks", artist: "Wade Bowen", duration: 226000, sing_start: 5000, sing_end: 208000, audio_id: 2 })
